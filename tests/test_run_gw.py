...
from src.cajal.utilities import read_gw_dists, read_gw_couplings, cell_iterator_csv, avg_shape_spt
import os
...
def test():
    ...
    avg_shape_spt(names, gw_dists, cell_icdms,
                  gw_coupling_mat_dict=gw_coupling_mat_dict,
                  k=7)
